  ...
  theme: {
    extend: {
      colors: {
        ...
        // == THEME COLORS FOR CREATOR APPLY PAGE ==
        ...
        "theme-primary-bg-subtle": "rgba(9, 30, 101, 0.04)",
        "theme-primary-border-light": "rgba(9, 30, 101, 0.1)",
        "theme-primary-border-subtle": "rgba(9, 30, 101, 0.15)",
        ...
        "theme-error-bg-subtle": "rgba(239, 68, 68, 0.05)",
        "theme-error-border-light": "rgba(239, 68, 68, 0.15)",
        "theme-error-border-subtle": "rgba(239, 68, 68, 0.2)",
        "theme-error-focus-ring": "rgba(239, 68, 68, 0.3)",

        "text-secondary-on-light": "#566172",
        "border-strong-on-light": "#d1d5db",
        "border-soft-on-light": "#e5e7eb",
      ...
      animation: {
        ...
        "fade-in-load": "fadeInLoad 0.7s ease-out forwards",
      ...
      backgroundImage: {
        ...
        "chart-placeholder-pattern":
          "url(\"data:image/svg+xml,%3Csvg width='52' height='26' viewBox='0 0 52 26' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23e5e7eb' fill-opacity='0.4'%3E%3Cpath d='M10 10c0-2.21-1.79-4-4-4-3.314 0-6-2.686-6-6h2c0 2.21 1.79 4 4 4 3.314 0 6 2.686 6 6 0 2.21 1.79 4 4 4 3.314 0 6 2.686 6 6 0 2.21 1.79 4 4 4v2c-3.314 0-6-2.686-6-6 0-2.21-1.79-4-4-4-3.314 0-6-2.686-6-6zm25.464-1.95l8.486 8.486-1.414 1.414-8.486-8.486 1.414-1.414z' /%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
