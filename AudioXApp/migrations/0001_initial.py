# Generated by Django 4.2.19 on 2025-05-13 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PUBLISHED', 'Published'), ('INACTIVE', 'Inactive'), ('REJECTED', 'Rejected'), ('PAUSED_BY_ADMIN', 'Paused by Admin')], db_index=True, default='PUBLISHED', help_text='The current status of the audiobook.', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audiobook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchases', to='AudioXApp.audiobook')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('earning_type', models.CharField(choices=[('sale', 'Sale Earning'), ('view', 'View Earning')], db_index=True, default='sale', max_length=10)),
                ...
                ('notes', models.TextField(blank=True, help_text="Any notes related to this earning (e.g., 'From audiobook sale', 'Monthly view payout').", null=True)),
                ('audiobook_title_at_transaction', models.CharField(blank=True, help_text='Title of the audiobook at the time of the transaction.', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file', models.FileField(null=True, upload_to='chapters/')),
